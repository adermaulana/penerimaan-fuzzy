...
<main id="main" class="main">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Tambah Jarak Rumah</h5>
                  <div class="container">
    <div class="row">
    ...
    @endif
    <form action="/dashboard/jarak_rumah" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row mt-3">
    ...
    <div class="form-group mt-2">
    <h6>Alamat</h6>
    <input type="tetx" name="alamat" value="{{ old('alamat') }}" class="form-control" >
    @error('alamat')
    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
    @enderror
    </div>
